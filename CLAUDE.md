...
This repository produces the **State of CMS 2026** report as modular Markdown. Follow the conventions below unless the user explicitly asks otherwise.
...
All report files live at the **repo root**:
